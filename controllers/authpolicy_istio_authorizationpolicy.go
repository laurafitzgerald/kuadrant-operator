...
import (
	...
	"fmt"
	"reflect"
	gatewayapiv1alpha1 "sigs.k8s.io/gateway-api/apis/v1alpha2"
...
func istioAuthorizationPolicyName(gwName string, targetRef gatewayapiv1alpha1.PolicyTargetReference) string {
