...
type LimitadorIstioSidecarReconciler struct {
	*reconcilers.BaseReconciler

	Client *dynamic.DynamicClient
}

func NewLimitadorIstioSidecarReconciler(mgr controllerruntime.Manager, client *dynamic.DynamicClient) *LimitadorIstioSidecarReconciler {
	return &LimitadorIstioSidecarReconciler{
		Client: client,
...
func (r *LimitadorIstioSidecarReconciler) Subscription() *controller.Subscription {
